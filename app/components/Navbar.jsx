...
<ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "": "bg-white shadow-sm bg-opacity-50 dark:border dark:border-white/50  dark:bg-transparent"}`}>
  <li><a className="fout-Ovo" href="#top">Home</a></li>
  <li><a className="fout-Ovo" href="#top">About me</a></li>
  <li><a className="fout-Ovo" href="#top">Services</a></li> 
  <li><a className="fout-Ovo" href="#top">My Work</a></li>
  <li><a className="fout-Ovo" href="#top">Contact me</a></li>
...
<button onClick={()=> setIsDarkMode(prev => !prev)}>
  ...
  <li><a className="fout-Ovo text-black dark:text-white "onClick={closeMenu} href="#top">About me</a></li>
  <li><a className="fout-Ovo text-black dark:text-white "onClick={closeMenu} href="#top">Services</a></li> 
  <li><a className="fout-Ovo text-black dark:text-white "onClick={closeMenu} href="#top">My Work</a></li>
  <li><a className="fout-Ovo text-black dark:text-white "onClick={closeMenu} href="#top">Contact me</a></li>
  </ul>
</div>
      </nav>
    </div>
